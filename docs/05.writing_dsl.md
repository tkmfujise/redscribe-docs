...
In Ruby, identifiers that start with an uppercase letter (A–Z) and have no arguments are interpreted as constants rather than methods. Therefore, to define such names dynamically, you need to use `const_missing`.
